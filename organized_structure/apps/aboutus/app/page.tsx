    ...
    <div>
      ...
      <section className="middle">
        <div className="info">
          ...
          <h5>
            ...
            dedicated to the comprehensive exploration and understanding of the
            world’s oceans. Developed as an academic initiative, this website
            aims to educate, engage, and inspire users by offering structured
            and scientifically-grounded insights into the biological layers of
            the ocean. The ocean covers more than 70% of the Earth’s surface,
            yet much of it remains unexplored and misunderstood. With this in
            mind, Oceanic Explorer was created to bridge the gap between
            scientific knowledge and public awareness. It serves as a learning
            tool for students, educators, researchers, and ocean enthusiasts who
            wish to delve deeper into the diverse ecosystems beneath the waves.
          </h5>
          <br />
          <br />
          <h1>Our Mission</h1>
          <h5>
            Our mission is to provide an engaging and educational platform that
            promotes ocean literacy through accurate information, interactive
            tools, and enjoyable experiences. We aim to spark curiosity about
            marine life, highlight the importance of ocean conservation, and
            encourage further study of this vital part of our planet.
          </h5>
          <br />
          <br />
          <h1>Key Features</h1>
          ...
          <h5>
            ...
            (sunlight) zone to the hadalpelagic (trenches) – each home to unique
          ...
          <h5>
            Make use of our intelligent search assistant to quickly navigate the
            site and receive detailed answers to marine-related queries.
          </h5>
          <br />
          <br />
      ...
      <section className="bottom">
        ...
        <h6>
          📬 Contact Information
          <p>
            We welcome feedback, collaboration inquiries, and questions related
            to marine education or the platform. Feel free to reach out using
          ...
          <p>
            ...
            ocean literacy and interactive digital learning. All inquiries will
            be responded to within 2–3 working days.
          </p>
        </h6>

...
export function game(){
    ...
    class Player{
        ...
        draw(){
            ...
            if(this.x>=mouse.x){
                ctx.drawImage(playerLeft,this.frameX*this.spriteWidth,this.frameY*this.spriteHeight,this.spriteWidth,this.spriteHeight,0-60,0-42,this.spriteWidth/4,this.spriteHeight/4);
            }else{
                ctx.drawImage(playerRight,this.frameX*this.spriteWidth,this.frameY*this.spriteHeight,this.spriteWidth,this.spriteHeight,0-60,0-42,this.spriteWidth/4,this.spriteHeight/4);
            }
            ctx.restore();
        }
    }

...
const anglerfish = () => {
  return (
    <div className="page-container">
      <video className="background-video" src="/videos/anglerfish.mp4" loop autoPlay muted></video>
      ...
      <section className="glass-panel">
        ...
        ><div className="Head">ANGLER FISH</div></GradientText>
...
<tr><td><strong>Scientific Name:</strong> Chordata</td></tr>
            <tr><td><strong>Order:</strong> Apodida (no tube feet, burrowers)</td></tr>
            <tr><td><strong>Family:</strong> Varies (e.g., Ceratiidae, Melanocetidae)</td></tr>
            <tr><td><strong>Body:</strong> Large, fang-like teeth</td></tr>
          </tbody>
        </table>
      </section>
    </div>

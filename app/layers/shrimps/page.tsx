    ...
    <>
      ...
      <div className="page-container">
        ...
        <section className="glass-panel">
          ...
          >
            <div className="Head">SHRIMPS</div>
          </GradientText>
          ...
          <table className="info-table">
            <tbody>
              ...
              <tr>
                <td>
                  <strong>Size:</strong> Typically 1 - 3 inches long, but can be
                  larger depending on species
                </td>
              </tr>
              <tr>
                <td>
                  <strong>Body structure:</strong> Segmented with a hard
                  exoskeleton
                </td>
              </tr>
            </tbody>

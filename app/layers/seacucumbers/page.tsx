    ...
    <>
      ...
      <div className="page-container">
        <video
          ...
          src="https://res.cloudinary.com/dgocm6tyt/video/upload/v1754175658/seacucumber_alt_pdcrad.mp4"
          loop
          autoPlay
          muted
        ></video>
        ...
        <section className="glass-panel">
          ...
          >
            <div className="Head">SEA CUCUMBERS</div>
          </GradientText>
          ...
          <table className="info-table">
            <tbody>
              ...
              <tr>
                <td>
                  <strong>Class:</strong> Holothuroidea
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <strong>Family:</strong> Soft, elongated, and leathery. They
                  usually have tube feet or tiny tentacles for movement and
                  feeding
                </td>
              </tr>
              <tr>
                <td>
                  <strong>Body:</strong> They live on the seafloor, mostly in
                  shallow waters but also at deep-sea depths.
                </td>
              </tr>
            </tbody>
          </table>

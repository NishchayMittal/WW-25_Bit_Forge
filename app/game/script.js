export function game() {
  ...
  const BG = { x1: 0, x2: 0, y: 0, width: 0, height: 0 };
  ...
  class Player {
    ...
    draw() {
      ...
      const img = this.x >= mouse.x ? playerLeft : playerRight;
      ctx.drawImage(
        img,
  ...
  function handleGameOver() {
    ...
    ctx.fillText('Tap to Restart', 200, 310);
    gameOver = true;
  }
  ...
  function setupControls() {
    ...
    canvas.addEventListener('touchstart', (e) => {
      ...
      mouse.x = touch.clientX - canvasPosition.left;
      mouse.y = touch.clientY - canvasPosition.top;
      mouse.click = true;
    }, { passive: false });
